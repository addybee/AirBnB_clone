...
"""
defines the unittest class for Amenity
"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_docstring(self):
        ...
        self.assertIsNotNone(__import__("models.amenity").__doc__)
    ...
    def test_from_dict_to_obj(self):
        """ test the conversion from dict to object(Amenity) """
        new_dict = self.model.to_dict()
        new_model = Amenity(**new_dict)
